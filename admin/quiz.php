                            ...
                            <table class="table table-striped">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                        <a href="tambahsoal.php?id=<?php echo $row['idq']; ?>" class="btn btn-success">Tambah</a>
                                        <a href="editquiz.php?id=<?php echo $row['idq']; ?>" class="btn btn-warning">Edit</a>
                                        <a href="deletequiz.php?id=<?php echo $row['idq']; ?>" class="btn btn-danger">Delete</a> </td>
                                    </tr>
                                    <?php }} ?>
                                </tbody>
                            </table>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="tambahquiz.php" method="post" enctype="multipart/form-data" >
                                <div class="col-md-12">
                                    <center>
                                        <h3>Tambah Kelas</h3>
                                    </center>
                                    ...
                                    <div class="form-group">
                                        <label>Benar</label>
                                        <input type="text" class="form-control" name="benar" required="required">
                                    </div>
                                    <div class="form-group">
                                        <label>Salah</label>
                                        <input type="text" class="form-control" name="salah" required="required">
                                    </div>
                                    <div class="form-group">
                                        <label>Total</label>
